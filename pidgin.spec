...
%prep
%setup -q -n pidgin-2.14.13
cd %{_builddir}/pidgin-2.14.13
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a pidgin-2.14.13 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708703689
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libpurple-client.so.0.14.13
/V3/usr/lib64/libpurple.so.0.14.13
...
/usr/lib64/libpurple-client.so.0.14.13
/usr/lib64/libpurple.so.0
/usr/lib64/libpurple.so.0.14.13
